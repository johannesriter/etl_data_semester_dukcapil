...
class ExampleHandler(FileSystemEventHandler):
    def on_created(self, event): # when file is created
        ...
        if substring in os.path.basename(namafile):
            print('process data')
            try :
                python_path = r'C:\Users\Administrator\AppData\Local\ESRI\conda\envs\arcgispro-py3-clone\python.exe' #r'/home/arcgis/miniconda3/bin/python'
                script_arcgis = r'D:\etl_data_semester_dukcapil\ETL_update_data_semester.py' #r'/home/arcgis/monitor_folder_SPH/update_attachment_SPH.py'
